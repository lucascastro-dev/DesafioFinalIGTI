	                ...
	                case "2":
	                    ...
	                    if (idFuncionario != -1){
	                        ...
	                        System.out.println("Funcionario: "+ selecionarFuncionario.getNome() + "\n"
	                                         + "Salario bruto: R$ "+ selecionarFuncionario.getSalarioBruto() + "\n"
	                                         + "INSS: R$ "+ selecionarFuncionario.getDescontoInss() + "\n"
	                                         + "IRFF: R$ "+ selecionarFuncionario.getDescontoIrrf() + "\n"
	                                         + "Salário líquido: R$ "+ selecionarFuncionario.getSalarioLiquido() + "\n");
	                        opcao = mostrarMenu();
	                        break;
	                    }
	                    else {
